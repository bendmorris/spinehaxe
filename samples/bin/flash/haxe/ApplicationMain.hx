...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("spinehx", "spinehx-AnimationStateTest", "org.bitbucket.nitrobin.spinehx.AnimationStateTest", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("AnimationStateTest");
