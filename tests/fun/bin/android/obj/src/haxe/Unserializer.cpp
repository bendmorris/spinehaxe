...
{
		HX_STACK_FRAME("haxe.Unserializer","setResolver",0x5545046d,"haxe.Unserializer.setResolver","/usr/lib/haxe/std/haxe/Unserializer.hx",125,0xcde24acb)
		HX_STACK_THIS(this)
		HX_STACK_ARG(r,"r")
		HX_STACK_LINE(125)
		if (((r == null()))){
...
{
		HX_STACK_FRAME("haxe.Unserializer","unserializeObject",0x1b3e66eb,"haxe.Unserializer.unserializeObject","/usr/lib/haxe/std/haxe/Unserializer.hx",172,0xcde24acb)
		HX_STACK_THIS(this)
		HX_STACK_ARG(o,"o")
		HX_STACK_LINE(173)
		while((true)){
...
Dynamic Unserializer_obj::unserializeEnum( ::Enum edecl,::String tag){
	HX_STACK_FRAME("haxe.Unserializer","unserializeEnum",0x5018b02d,"haxe.Unserializer.unserializeEnum","/usr/lib/haxe/std/haxe/Unserializer.hx",187,0xcde24acb)
	HX_STACK_THIS(this)
...
Dynamic Unserializer_obj::unserialize( ){
	HX_STACK_FRAME("haxe.Unserializer","unserialize",0x92cca30c,"haxe.Unserializer.unserialize","/usr/lib/haxe/std/haxe/Unserializer.hx",219,0xcde24acb)
	HX_STACK_THIS(this)
	HX_STACK_LINE(220)
	{
		HX_STACK_LINE(220)
		...
		switch( (int)(_g)){
			...
			case (int)111: {
				struct _Function_3_1{
					inline static Dynamic Block( ){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/haxe/Unserializer.hx",276,0xcde24acb)
						{
							hx::Anon __result = hx::Anon_obj::Create();
							return __result;
						}
...
Dynamic Unserializer_obj::run( ::String v){
	HX_STACK_FRAME("haxe.Unserializer","run",0xa8f8f8f0,"haxe.Unserializer.run","/usr/lib/haxe/std/haxe/Unserializer.hx",434,0xcde24acb)
	HX_STACK_ARG(v,"v")
	HX_STACK_LINE(434)
