...
{
HX_STACK_FRAME("haxe.io.BytesBuffer","new",0x022790dd,"haxe.io.BytesBuffer.new","/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",45,0x63ceceb4)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(54)
...
::haxe::io::Bytes BytesBuffer_obj::getBytes( ){
	HX_STACK_FRAME("haxe.io.BytesBuffer","getBytes",0x1e9f7258,"haxe.io.BytesBuffer.getBytes","/usr/lib/haxe/std/haxe/io/BytesBuffer.hx",173,0x63ceceb4)
	HX_STACK_THIS(this)
	HX_STACK_LINE(189)
