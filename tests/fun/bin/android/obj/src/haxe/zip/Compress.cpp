...
Dynamic Compress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Compress","execute",0xd015e2fe,"haxe.zip.Compress.execute","/usr/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",34,0x8f1f5343)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Compress","close",0x6942fc41,"haxe.zip.Compress.close","/usr/lib/haxe/std/cpp/_std/haxe/zip/Compress.hx",42,0x8f1f5343)
		HX_STACK_THIS(this)
		HX_STACK_LINE(42)
