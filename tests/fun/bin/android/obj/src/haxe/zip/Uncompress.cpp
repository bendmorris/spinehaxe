...
Dynamic Uncompress_obj::execute( ::haxe::io::Bytes src,int srcPos,::haxe::io::Bytes dst,int dstPos){
	HX_STACK_FRAME("haxe.zip.Uncompress","execute",0xb3589a97,"haxe.zip.Uncompress.execute","/usr/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",33,0x466e914a)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("haxe.zip.Uncompress","close",0x4cc86b9a,"haxe.zip.Uncompress.close","/usr/lib/haxe/std/cpp/_std/haxe/zip/Uncompress.hx",41,0x466e914a)
		HX_STACK_THIS(this)
		HX_STACK_LINE(41)
